...
int main()
{
	...
	list<char> list2 = make<list<char> >("except Congress. - Mark Twain");
	...
	cout << "Demonstrating multiset count member function." << endl;
	i = multiset1.lower_bound('s');
	j = multiset1.upper_bound('s');

	pair<multiset<char>::iterator, multiset<char>::iterator>
	...
	assert("       ATaaaatttvy" == make_string(multiset1));
